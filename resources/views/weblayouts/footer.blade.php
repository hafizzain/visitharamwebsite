<footer class="bg-white">
    <div class="container mx-auto px-5 lg:px-10 xl:px-24 pt-10 pb-5 text-[#110928]">
        <div class="grid lg:grid-cols-5 gap-5">
            <div class="sm:col-span-2">
                <a href="#" class="flex items-center mb-4">
                    <span class="self-center text-2xl font-semibold whitespace-nowrap ">About Us</span>
                </a>
                <p>Visit Haram is the most trusted & reliable agency among UK Muslims. We provide bespoke Umrah travel solutions & package designing services to meet budget range and facilities requirements of pilgrims. </p>
            </div>
            <div>
                <h2 class="mb-4 font-semibold text-gray-900 uppercase ">Visit Haram</h2>
...
{{--                    <li><a href="#" class="hover:underline">Download</a></li>--}}
    ...
    <hr class="sm:my-4 my-2 border-[#C2C2C2] sm:mx-auto" />
    <div class="flex flex-col gap-3 sm:gap-0 sm:flex-row items-center justify-between container mx-auto px-5 md:px-10 xl:px-24 sm:py-6 py-4">
        <div class="flex space-x-6 sm:justify-center items-center">
            <a href="#" class="text-[#180F34] hover:text-gray-900">
            ...
            <a href="#" class="text-[#180F34] hover:text-gray-900 pt-[1px] sm:pt-[2px]">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                    <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854zm4.943 12.248V6.169H2.542v7.225zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248S2.4 3.226 2.4 3.934c0 .694.521 1.248 1.327 1.248zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016l.016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225z"/>
                </svg>
            </a>

        </div>
        <span class="text-sm text-[#180F34] sm:text-center ">© Copyright <a href="/" class="hover:underline">Visit Haram</a> <script>
