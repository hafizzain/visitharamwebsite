        ...
        <div class="flex flex-col lg:flex-row">
            ...
            <div class="lg:w-2/3 lg:py-8 pr-3 sm:px-5">
                <div class="menu__container space-y-7">
                    <div class="">
                        <div
                            class="menu__heading__container flex items-center justify-between pb-7 border-b border-[#DFDFDF] border-solid">
                            <h3 class="">How to Book Flights?</h3>
                            <button class="" onclick="toggleAccordion(this)"><i
                                    class="fa-solid fa-chevron-down"></i></button>
                        </div>
                        <div class="menu__detail__container hidden py-7">
                            <p>You can contact our Professional Travel Consultants on 0203-195-8700, for your Flights to the holiest hub of Muslims. You can get both direct and indirect flights to the Kingdom of Saudi Arabia.
...
For an Umrah Visa, if you hold non-European nationality, you need to apply for an Umrah Visa, which is valid for 90 days with single entry only. To obtain an Umrah Visa, you must download the Saudi Bio App from the Google Play Store and complete the enrollment process by scanning your documents. Afterward, you need to send the enrollment ID received from mofa.govt.sa to us for further visa processing. Please be aware that Umrah Visa holders are not permitted to visit any other city of Saudi Arabia except Makkah & Madinah</p>
                    ...
                    <div class="">
                        ...
                        <div class="menu__detail__container hidden py-7 space-y-3">
                            <p>To secure your hotel accommodation in Makkah and Madinah, please contact our expert travel counsellors at 0203-195-8700. They will assist you in finding the best available hotels in Makkah and Madinah that align with your preferences and budget.</p>
                    ...
                    <div class="">
                        <div
                            class="menu__heading__container flex items-center justify-between pb-7">
                            <h3 class="font-medium">How to Contact Makkah Tours?</h3>
                            <button onclick="toggleAccordion(this)"><i class="fa-solid fa-chevron-down"></i></button>
                        </div>
