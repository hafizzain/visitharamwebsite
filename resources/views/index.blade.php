                    ...
                    <div class="mb-5 w-full relative">
                        ...
                        <div class="w-full">
                            <div class="flex items-center">
                                <select class="minimal w-[120px] h-[36.6px] xl:h-[41.6px] bg-gray-50 border border-gray-300 text-black placeholder:text-black text-sm rounded-l-lg rounded-r-none focus:ring-[#E1C844] focus:border-[#E1C844] block p-2.5">
